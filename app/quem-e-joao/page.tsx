...
export const metadata: Metadata = {
  ...
  description: 'Conheça a trajetória de João Carlos Rodrigues, o João da 5 Irmãos: comerciante, vereador de Curitiba e candidato a deputado federal pelo Paraná.',
};
