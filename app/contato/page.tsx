...
export const metadata: Metadata = { title: 'Contato | João da 5 Irmãos 1599', description: 'Fale com a campanha de João da 5 Irmãos pelo WhatsApp, Instagram e YouTube.', alternates: { canonical: '/contato' } };
