...
export function SiteFooter() {
  return <footer className="site-footer"><div className="wrap">
    <div className="footer-brand">
      ...
      <span className="footer-office">Candidato a deputado federal<br />Paraná</span>
    ...
    <div className="footer-nav" aria-label="Links do rodapé">
      ...
      <a href={campaign.whatsapp} target="_blank" rel="noopener noreferrer">Grupo de WhatsApp</a>
    </div>
    <div className="legal">
      <p>ELEIÇÃO 2026 JOÃO CARLOS RODRIGUES CANDIDATO A DEPUTADO FEDERAL</p>
